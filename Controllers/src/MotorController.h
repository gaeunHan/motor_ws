...
private:
    ...
    float pos_tick, vel_tick, acc_tick, jerk_tick;

    /* logging vars. */
    vector<float> t1_array;
    vector<float> position_input_array;
    vector<float> velocity_input_array;
    vector<float> acceleration_input_array;
    vector<float> jerk_input_array;
...
public:
    ...
    void saveData(const string &position_filename, const string &velocity_filename, const string &acceleration_filename, const string &jerk_filename);    
};